...
<body class="bg-DefaultWhite">
    ...
    <script>
        ...
        document.getElementById('addOrphanageForm').addEventListener('submit', function(e) {
            ...
            // Get form data
            const name = document.getElementById('orphanageName').value;
            const address = document.getElementById('orphanageAddress').value;
            const city = document.getElementById('orphanageCity').value;
            const contact = document.getElementById('orphanageContact').value;
            const donation = document.getElementById('orphanageDonation').value;
